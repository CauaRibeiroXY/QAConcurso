...
function criarGraficoEvolucaoGeral(dadosEvolucao) {
    const ctx = document.getElementById('grafico-evolucao-geral').getContext('2d');
...
function criarGraficoDesempenhoEixos(dadosPorEixo) {
    const ctx = document.getElementById('grafico-desempenho-eixos').getContext('2d');
...
function criarGraficoEvolucaoEixos(dadosEvolucaoEixos) {
    const ctx = document.getElementById('grafico-evolucao-eixos').getContext('2d');
...
function showError(mensagem) {
    document.getElementById('loading-section').style.display = 'none';
    // Você pode implementar uma seção de erro se desejar
    alert(mensagem);
}
